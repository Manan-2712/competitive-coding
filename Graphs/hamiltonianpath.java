...
public class hamiltonianpath {
    ...
    public static void hamiltonian(ArrayList<Edge>[] graphs, int osrc, int src, HashSet<Integer> visited, String psf) {
        ...
        for (Edge e : graphs[src]) {
            if (visited.contains(e.nbr) == false) {
                hamiltonian(graphs, osrc, e.nbr, visited, psf + e.nbr);
            }
        }
        visited.remove(src);
    }
